...
class TutorialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tutorial" do
    assert_difference('Tutorial.count') do
      post tutorials_url, params: { tutorial: { description: @tutorial.description, image_link: @tutorial.image_link, link: @tutorial.link, title: @tutorial.title, user_id: @tutorial.user_id } }
    end
  ...
  test "should update tutorial" do
    patch tutorial_url(@tutorial), params: { tutorial: { description: @tutorial.description, image_link: @tutorial.image_link, link: @tutorial.link, title: @tutorial.title, user_id: @tutorial.user_id } }
